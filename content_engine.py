"""
Content Engine ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Intelligent Growth Machine Powered by Claude
==============================================================
...
# ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Context Intelligence Layer ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
...
def _build_duplicate_guard(existing_queue: list, post_history: list) -> str:
    ...
    # From existing queue (not yet posted ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ highest priority to avoid)
    ...
    if latest_report:
        ...
        if suggestions:
            ...
            for s in suggestions[:3]:
                context += f"  - [{s.get('pillar', '?')}] {s.get('topic_hint', '?')} ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ {s.get('why', '')}\n"
...
def _select_smart_template(existing_queue: list, post_history: list, scheduled_day: str = None) -> dict:
    """
    Select a viral template intelligently ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ preferring day-appropriate templates
...
def _build_growth_phase_context(post_history: list) -> str:
    ...
    if total_posts < 30:
        phase = "PHASE 1 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Foundation Building"
        guidance = (
        ...
        phase = "PHASE 2 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Viral Growth"
        guidance = (
        ...
        phase = "PHASE 3 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Authority & Scale"
        guidance = (
...
# ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Post Generation ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
...
def generate_post(
    ...
    # ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Intelligence Layer: Build rich context ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
    ...
    gopipways_rule = (
        ...
        "But Gopipways should NEVER be the main topic ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ it's a supporting detail in a larger story."
        ...
        "You are Dr. Aaron Akwu the forex educator and thought leader ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ not a brand ambassador."
    )
    ...
    if topic_list:
        ...
        topic_suggestions_text += "\nUse these as INSPIRATION ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ adapt and create fresh angles, don't copy verbatim.\n"
    ...
    system_prompt = f"""You are the LinkedIn ghostwriter for Dr. Aaron Akwu ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Africa's leading forex educator.

You are executing the "LinkedIn 20K Growth Strategy" ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ a detailed plan to grow Aaron's followers from 4,500 to 20,000+.
...
- Write like a respected thought leader who happens to teach forex ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ not like a company marketing page.
...
20K GROWTH STRATEGY ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ CORE PLAN
ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
...
HASHTAG STRATEGY (This Week ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Week {week_num} of 4-week rotation):
...
2. Open with a scroll-stopping hook (first 2 lines show before "see more" ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ make them count)
3. The hook MUST be unique ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ never repeat hooks from the Intelligence Briefing
...
12. Reference specific numbers, names, timeframes ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ vague posts don't go viral
...
15. The CTA should be SPECIFIC ("Drop a PLAN in the comments", "Reply with your letter", "What's your daily loss limit?") ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ not generic ("Let me know what you think")

IMAGE PROMPT RULES:
- Describe a PHOTOREALISTIC scene ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ like a real photograph taken by a professional photographer
...
- NEVER use abstract/conceptual/surreal imagery ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ keep it grounded and real
...
{{
  ...
  "image_prompt": "A detailed PHOTOREALISTIC image prompt (describe a real scene with specific camera, lighting, setting, subjects, camera angle ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ editorial/documentary photography style, no text or logos)",
...
IMPORTANT: Your post must be ORIGINAL. Check the Intelligence Briefing for hooks and topics already used ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ do NOT repeat them.
...
# ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Performance Analysis ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
...
# ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Intelligent Content Queue Management ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
...
def load_full_context() -> dict:
    ...
    logger.info(
        f"Context loaded ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Queue: {len(existing_queue)} posts, "
...
def generate_weekly_content(optimize_from: list = None, progress_callback=None) -> list:
    ...
    for idx, (day, schedule) in enumerate(schedule_items):
        ...
        _progress(f"Generating post {post_num}/{total}: {day.capitalize()} ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ {schedule['pillar_preference']} ({post_type})...")
        ...
        try:
            ...
            # ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Assign REAL calendar dates ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
            ...
            _progress(f"Post {post_num}/{total} done: {post.get('pillar')} ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ {post.get('hook', '')[:50]}...")
    ...
    logger.info(f"Weekly content generation complete ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ {len(weekly_posts)} intelligent posts created")
    return weekly_posts
...
def generate_instagram_post(
    ...
    - Voice: Company ("We", "Gopipways") ÃÂ¢ÃÂÃÂ NOT first-person like LinkedIn
    ...
    system_prompt = (
        "You are the Instagram content writer for Gopipways â Africa's leading forex education platform.\n"
        "Every post MUST apply all six laws of the master sales framework below without exception.\n\n"
        "BRAND VOICE: Direct, empathetic, street-smart. Speak to the Nigerian/African trader who is "
        "tired of losing money and ready to act. Never corporate. Never generic. NEVER lead with the brand.\n\n"
        "THE 6-LAW MASTER FRAMEWORK:\n\n"
        "LAW 1 â PAIN BEFORE PRODUCT (The Mom Test)\n"
        ...
        "LAW 2 â IRRESISTIBLE OFFER FRAMING ($100M Offers)\n"
        "Stack value in Nigerian naira. Make the offer feel like a steal.\n"
        "Example: 'What traders pay \u20a650,000 to learn in bootcamps, we break down free every week.'\n"
        "Always anchor with \u20a6 figures â \u20a65,000 / \u20a650,000 / \u20a6200,000 â to make value tangible.\n\n"
        "LAW 3 â HOOK to STORY to OFFER (Dotcom Secrets)\n"
        "Every post: HOOK (interrupt the scroll â bold question, shocking stat, or controversial truth) "
        ...
        "LAW 4 â TACTICAL EMPATHY BEFORE THE ASK (Never Split the Difference)\n"
        ...
        "It is not â you just have not had the right system yet.'\n\n"
        "LAW 5 â LOSS AVERSION, ANCHORING & SOCIAL PROOF (Predictably Irrational)\n"
        "Use fear of loss over promise of gain. Anchor with \u20a6 and community numbers.\n"
        "Example: 'Every week you trade without a strategy, you are not just losing money â "
        "you are losing time you cannot buy back.'\n"
        "Social proof: 'Traders across Lagos, Abuja, and Port Harcourt already...'\n\n"
        "LAW 6 â TRADER IS HERO, GOPIPWAYS IS GUIDE (Building a StoryBrand)\n"
        ...
        "GOOD: 'You are one strategy away from consistent profits â we have built the roadmap'\n\n"
        "POST ANATOMY (use every single time):\n"
        "1. PAIN â sharp, specific pain point (1 sentence)\n"
        "2. STORY â bridge pain to possibility (1-2 sentences)\n"
        "3. PROOF â social proof, stat, or \u20a6 anchor (1 sentence)\n"
        "4. OFFER â what Gopipways provides, specific and tangible (1 sentence)\n"
        "5. CTA â single action only, always gopipways.com\n\n"
        "NIGERIAN LOCALIZATION (mandatory in every post):\n"
        "Use \u20a6 (naira) for ALL monetary figures. "
        "Reference CBN decisions, NGX stocks, Lagos/Abuja/Port Harcourt markets when relevant. "
        "Lagos NSE: opens 10am WAT, closes 2:30pm WAT. Use WAT (UTC+1) for trading windows. "
        "Trader pain: power cuts, poor internet, dollar scarcity, CBN forex restrictions.\n\n"
        "FORBIDDEN PHRASES â never write: 'game-changer', 'revolutionary', 'cutting-edge', "
        "'world-class', 'We are proud to...', 'Exciting news!', 'We are thrilled...', "
        "'Join our community', 'Do not miss out', 'financial freedom' without specific \u20a6 figures, "
        ...
        "INSTAGRAM FORMAT:\n"
        "Caption: 150-300 characters total. First line must be the scroll-stopping HOOK â make it count.\n"
        "Hashtags go at the very end after the CTA, on a new line.\n"
        "The image supports the post â assume it exists, do not describe it in the caption.\n"
    )
    user_prompt = (
...
def generate_facebook_post(
    ...
    - Voice: Company ("We", "Gopipways") ÃÂ¢ÃÂÃÂ same brand as Instagram but different format
    ...
    system_prompt = (
        "You are the Facebook content writer for Gopipways â Africa's leading forex education platform.\n"
        "Every post MUST apply all six laws of the master sales framework below without exception.\n\n"
        "BRAND VOICE: Direct, empathetic, street-smart. Speak to the Nigerian/African trader who is "
        "tired of losing money and ready to act. Never corporate. Never generic. NEVER lead with the brand.\n\n"
        "THE 6-LAW MASTER FRAMEWORK:\n\n"
        ...
        "End with a question OR a bold declarative statement. No buzzwords.\n\n"
        "FACEBOOK FORMAT:\n"
        "Post: 200-500 characters. Slightly more narrative â community members sharing wins feel authentic.\n"
...
def generate_threads_post(
    ...
    Threads rules:
    - Voice: Company but conversational Ã¢ÂÂ sounds like a smart human, not a brand account
    ...
    system_prompt = (
        "You are the Threads content writer for Gopipways â Africa's leading forex education platform.\n"
        "Every post MUST apply all six laws of the master sales framework below without exception.\n\n"
        "BRAND VOICE: Direct, empathetic, street-smart. Speak to the Nigerian/African trader who is "
        "tired of losing money and ready to act. Never corporate. Never generic. NEVER lead with the brand.\n\n"
        "THE 6-LAW MASTER FRAMEWORK:\n\n"
        ...
        "End with a question OR a bold declarative statement. No buzzwords.\n\n"
        "THREADS FORMAT:\n"
        "Post: 280-500 characters. Conversational â like a direct message to a fellow trader.\n"
...
# ═══════════════════════════════════════════════════════════════════════════════
# GOPIPWAYS COMPANY POSTS — Single call generates IG + Facebook + Threads
...
def generate_company_post(
    ...
    # ── Auto-select pillar by day of week ──────────────────────────────────────
    if not pillar:
    ...
    system_prompt = (
        ...
        "live trading signals, live weekly webinars with pro traders, and 34 free lessons — "
        "all in one place. Built for African traders. 100% free to start.\n\n"
        "=== ALL 8 PRODUCTS ===\n"
        "1. AI Chart Analysis — upload any chart screenshot → entry, stop loss, take profit "
        "in seconds. Uses Smart Money Concepts. Explains its reasoning step by step.\n"
        "2. Personal AI Mentor — available 24/7, knows your full history, adapts to your level.\n"
        "3. AI Trading Signals — institutional-grade signals with full technical breakdown. "
        "You see the WHY behind every call, not just a direction.\n"
        "4. Live Weekly Webinars — real-time with professional traders, NOT pre-recorded. "
        "Ask questions, get live feedback on your trades.\n"
        "5. Performance Analytics — import MT4/MT5 statement, get win rate, profit factor, "
        "drawdown, and AI coaching on your specific weaknesses.\n"
        "6. Risk Calculator — correct position size for every trade in seconds.\n"
        "7. 34-Lesson Free Academy — 5 levels: Beginner to Expert. Candlesticks, indicators, "
        "risk management, Smart Money Concepts, institutional trading. Free forever.\n"
        "8. AI Stock Research — NGX stocks (MTNN, DANGCEM, GTCO, Zenith, Seplat, Access, Nestle) "
        "plus global stocks, forex pairs, and crypto. One unified terminal.\n\n"
        "=== PRICING (use for value stacking) ===\n"
        "Free: \u20a60 — full 34-lesson academy + 2 chart analyses + 3 AI mentor questions/day. NO CARD REQUIRED.\n"
        "Basic: \u20a620,000/month — 30 chart analyses, 25 mentor questions/day, full signals.\n"
        "Pro: \u20a635,000/month — unlimited everything, priority support.\n"
        ...
        "LAW 1 — PAIN BEFORE PRODUCT: Open with the trader's lived pain. Make them feel seen FIRST.\n"
        "LAW 2 — IRRESISTIBLE OFFER: Stack value in local currency. Make the free offer feel like a steal.\n"
        "LAW 3 — HOOK → STORY → OFFER: Every post must follow this 3-part structure.\n"
        "LAW 4 — TACTICAL EMPATHY: Label the emotion first. Show you understand before you pitch.\n"
        "LAW 5 — LOSS AVERSION + SOCIAL PROOF: Fear of loss over promise of gain. Use real stats.\n"
        "LAW 6 — TRADER IS HERO, GOPIPWAYS IS GUIDE: The trader is always the hero. Never lead with brand.\n\n"
        "=== POST ANATOMY (every post, every platform) ===\n"
        "1. PAIN — sharp specific pain (1 sentence)\n"
        "2. STORY — bridge pain to possibility (1-2 sentences)\n"
        "3. PROOF — stat, testimonial, or currency anchor (1 sentence)\n"
        "4. OFFER — what Gopipways specifically provides (1 sentence)\n"
        "5. CTA — single action: www.gopipways.com\n\n"
        "=== PAN-AFRICAN LOCALIZATION ===\n"
        "Audience is ALL African traders — not just Nigeria. Use USD for monetary anchoring "
        ...
        "=== CTA ===\n"
        "Always www.gopipways.com — never just gopipways.com (the bare domain has issues).\n\n"
        "=== OUTPUT FORMAT ===\n"
